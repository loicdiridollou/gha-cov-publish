...
async function run() {
    try {
        let json = (0, parser_1.parse_file)("coverage311.xml");
        let [module_cov, file_cov] = (0, parser_1.rebuild_coverage_file)(json);
        console.log(module_cov, file_cov);
        let repo_url = process.env.GITHUB_URL;
        let base_sha = process.env.BASE_SHA;
...
var convertXMLtoJson = __nccwpck_require__(6189);
